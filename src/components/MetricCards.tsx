...
export const MetricCards: React.FC<MetricCardsProps> = ({
  ...
  return (
    <div className="space-y-4 mb-8">
      ...
      <div className="p-5 rounded-3xl bg-gradient-to-r from-slate-900 via-slate-900/90 to-slate-950 border border-teal-500/30 shadow-2xl relative overflow-hidden">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-extrabold uppercase tracking-wider text-slate-200">
                Home Vault Dashboard Overview
              </h2>
            </div>
            <p className="text-xs text-slate-400 mt-1">
              Real-time summary of tracked family assets, active protection & renewal alerts
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 w-full lg:w-auto">
            {/* Stat 1: Total Asset Value Tracked */}
            <div className="p-3.5 rounded-2xl bg-slate-950/80 border border-emerald-500/30 flex items-center gap-3">
              ...
              <div>
                <span className="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider block">
                  Total Asset Value Tracked
                </span>
                <span className="text-lg font-black text-emerald-400 font-mono tracking-tight block">
            ...
            <div
              ...
              className="p-3.5 rounded-2xl bg-slate-950/80 border border-teal-500/30 flex items-center gap-3 cursor-pointer hover:border-teal-400 transition-colors"
            >
              ...
              <div>
                ...
                <span className="text-lg font-black text-teal-300 font-mono tracking-tight block">
                  {metrics.activeCount} <span className="text-xs text-teal-400 font-sans font-bold">Protected</span>
                </span>
              </div>
            </div>

            {/* Stat 3: Expiring Soon Count */}
            <div
              onClick={() => onFilterStatus?.('expiring_soon')}
              className="p-3.5 rounded-2xl bg-slate-950/80 border border-amber-500/30 flex items-center gap-3 cursor-pointer hover:border-amber-400 transition-colors"
            >
              <div className="p-2.5 rounded-xl bg-amber-500/10 text-amber-400 border border-amber-500/20 shrink-0">
                <AlertTriangle className="w-5 h-5 stroke-[2.5] animate-pulse" />
              </div>
              <div>
                <span className="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider block">
                  Expiring Soon Count
                </span>
                <span className="text-lg font-black text-amber-400 font-mono tracking-tight block">
                  {metrics.expiringSoonCount} <span className="text-xs text-amber-300 font-sans font-bold">Alerts</span>
                </span>
              </div>
            </div>
          </div>
