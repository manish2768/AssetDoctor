      ...
      <section className="relative pt-12 pb-16 px-4 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6 relative z-10">
          ...
          <p className="text-base sm:text-lg text-slate-300 max-w-2xl mx-auto leading-relaxed font-normal">
            Store, track, and manage all your assets—gadgets, home appliances, and more in one smart app.
          </p>
          ...
          <div className="mt-4 text-xs text-slate-400 font-medium flex items-center justify-center gap-2">
            ...
            <span>Trusted by <strong className="text-white">10,000+</strong> smart asset owners in India</span>
          </div>
