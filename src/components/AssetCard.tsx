...
export const AssetCard: React.FC<AssetCardProps> = ({
  ...
  const renderStatusBadge = (status: WarrantyStatus, daysRemaining: number) => {
    if (daysRemaining <= 0) {
      return (
        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-black uppercase tracking-wider bg-rose-500/20 text-rose-300 border border-rose-500/50 shadow-md shadow-rose-500/10">
      ...
      return (
        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-black uppercase tracking-wider bg-amber-500/25 text-amber-300 border border-amber-500/50 shadow-md shadow-amber-500/20 animate-pulse">
      ...
      return (
        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-black uppercase tracking-wider bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 shadow-md shadow-emerald-500/10">
