...
const ONBOARDING_SLIDES: SlideData[] = [
  ...
  {
    title: 'AssetDoctor AI Scanner & Scam Guard',
    subtitle: 'High Precision OCR & Merchant Verification',
    description: 'Snap a picture of any invoice, warranty card, or vehicle document. AssetDoctor automatically extracts line items, GSTIN, warranty terms, and verifies merchant authenticity.',
    mascotState: 'success',
    icon: <ScanText className="w-5 h-5 text-emerald-400" />,
    badge: 'AI Instant Extraction',
    highlights: [
  ...
  {
    title: 'Automated Expiry & Resale Alerts',
    subtitle: 'Never Lose a Warranty Claim Again',
    description: 'AssetDoctor proactively monitors 30-day, 60-day, and 90-day expiry windows, sending timely service reminders and tracking real-time asset resale values.',
    mascotState: 'welcome',
